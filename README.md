# Cloud Run OpenAI Chat App with Cloud Code

"Chat App" is a [Cloud Run](https://cloud.google.com/run/docs) application that renders a simple webpage with an OpenAI response.
